...
async def test_get_actions(
    ...
    """Test we get the expected actions from a rhasspycontrol."""
...
async def test_action(hass: HomeAssistant) -> None:
    ...
    turn_off_calls = async_mock_service(hass, "rhasspycontrol", "turn_off")
    turn_on_calls = async_mock_service(hass, "rhasspycontrol", "turn_on")
