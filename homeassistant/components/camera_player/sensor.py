"""Sensor platform for Camera Player integration."""
...
async def async_setup_entry(
    ...
    async_add_entities([camera_playerSensorEntity(unique_id, name, entity_id)])


class camera_playerSensorEntity(SensorEntity):
    """camera_player Sensor."""

    def __init__(self, unique_id: str, name: str, wrapped_entity_id: str) -> None:
        """Initialize camera_player Sensor."""
        super().__init__()
