...
class WyomingSatelliteRingButton(WyomingSatelliteEntity, ButtonEntity):
...
class WyomingSatelliteTestNotifyButton(WyomingSatelliteEntity, ButtonEntity):
...
class WyomingSatelliteSpeakLastNotificationButton(WyomingSatelliteEntity, ButtonEntity):
